Shader "Hair/ShortHair"
{
    Properties
    {
    	...
    	_MedulaScatter("Medula Scatter", Range(0, 1)) = 0.1
    	_MedulaAbsorb("Medula Absorb", Range(0, 1)) = 0.1
    }
    SubShader
    {
		Pass
		{
	        ...
	        float4 frag(v2f i) : SV_Target
	        {
	        	...
	        	hair.kappa = _Kappa;
	        	hair.layer = _Layer;
	        	hair.medulaAbsorb = _MedulaAbsorb;
	        	hair.medulaScatter = _MedulaScatter;
	        	...
	        	result += /*lightColor * */ShortHairBXDF(hair, hair.normal, viewDir, lightDir, 1, 1, 0);
				result += /*indirectDiffuse **/ 6.28 * ShortHairBXDF(hair, hair.normal, viewDir, lightDir, 1, 0, 0.2);
